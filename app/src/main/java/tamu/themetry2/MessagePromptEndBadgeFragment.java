...
public class MessagePromptEndBadgeFragment extends Fragment {
    ...
    public void setBadgeText1(View v){
        TextView badgeText = (TextView) v.findViewById(R.id.promptEndText);
